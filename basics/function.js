...
function addNumber(num1, num2){        //parameter
    const type = typeof num1;   
    if(type != Number && !num1 && !num2  ){
...
const res = addNumber('a',5);           //fn reference & execute and saving return value from fn to variable res.
...
function calPrice(...num){           //rest operator
   return num;
}
...
const addTwo = (num1,num2) => {              //when using curly then return is used
    return num1 + num2;
}
addTwo(3,4);
